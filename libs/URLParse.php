...
class URLParse
{
    ...
    private static $DIRS_TO_IGNORE = 1;
    ...
    private static $PAGE_INFO = array(
			...
			"accept_employee" => array(
				P_WIDTH=> "900",
				P_FILE => "accept_employee.php",
				P_TITL => "Accept Employee",
			...
			"applicant" => array(
				...
				P_METD => "Applicant Registration ",
				P_METK => "Applicant, Apply, Registration"),
			"call_interview" => array(
				P_WIDTH=> "900",
				P_FILE => "call_interview.php",
				P_TITL => "Call for Interview",
				P_METD => "Applicant Registration ",
				P_METK => "Applicant, Apply, Registration"),
			"city" => array(
				P_FILE => "city.php",
			...
			"vacancy_type" => array(
				P_FILE => "vacancy_type.php",
				P_TITL => "Vacancy Type",
				P_METD => "",
				P_METK => ""),						
			"working" => array(
				P_FILE => "working.php",
				P_TITL => "Working Experience",
				P_METD => "Applicant Registration ",
				P_METK => "Applicant, Apply, Registration"),
